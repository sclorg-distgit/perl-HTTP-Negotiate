%{?scl:%scl_package perl-HTTP-Negotiate}

Name:           %{?scl_prefix}perl-HTTP-Negotiate
Version:        6.01
Release:        26%{?dist}
...
%changelog
* Fri Feb 14 2020 Petr Pisar <ppisar@redhat.com> - 6.01-26
- Import to SCL
